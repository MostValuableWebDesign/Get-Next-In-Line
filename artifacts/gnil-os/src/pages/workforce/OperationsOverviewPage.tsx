...
import { AlertCircle, CheckCircle2, CloudCog, ArrowRight, Zap, RefreshCw, Layers } from "lucide-react";
              ...
              {data.capabilityAssignments.map((assignment) => (
                <div key={assignment.capability} className="p-5 flex flex-col justify-between hover:bg-muted/10 transition-colors">
                  <div className="mb-4 flex items-center justify-between">
                    ...
                    <Badge variant={assignment.state === 'connected' ? 'default' : 'secondary'} className={assignment.state === 'connected' ? 'bg-primary/10 text-primary hover:bg-primary/20 hover:text-primary border-none' : ''}>
                      {assignment.state === 'connected' ? 'Connected' : 'Unavailable'}
                    </Badge>
                  </div>
