...
- With this workspace's Zod v3, OpenAPI `format: uri` generates `zod.url()`, a Zod v4-only API. **How to apply:** expose URLs as plain `type: string` until the Zod generator/runtime is upgraded together.
