...
- [Drizzle migrations](drizzle-migrations.md) — schema changes go through `pnpm run db:push` (generate+migrate); never `drizzle-kit push`, it prompts even with --force in non-TTY shells.
